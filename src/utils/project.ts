 ...
 */
export function getTemplateName(baseTemplate: string, config: ProjectConfig): string {
...
export async function updatePackageJson(
  ...
  packageJson.description = packageJson.description || `${projectName} - Generated by MVP Template Generator`;
 ...
 */
export async function installDependencies(targetDir: string, config: ProjectConfig) {
...
export async function setupTypeScript(targetDir: string) {
  ...
  console.log(chalk.yellow('TypeScript setup is now handled by template structure'));
}
...
export async function setupESBuild(targetDir: string) {
  ...
  console.log(chalk.yellow('ESBuild setup is now handled by template structure'));
}
